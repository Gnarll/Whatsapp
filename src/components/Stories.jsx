...
const stories = [
  {
    image: 'https://www.exibartstreet.com/wp-content/uploads/avatars/2465/5e0de52aeee8b-bpfull.jpg',
    name: 'Arman',
  },
  {
  ...
  {
    image: 'https://sammyplaysdirty.com/wp-content/uploads/2017/06/user-avatar-pic3.jpg',
    name: 'Adele',
  },
  {
    image:
    ...
    <ScrollView horizontal style={{ marginVertical: 20 }}>
      ...
      {stories.map((story) => (
        <TouchableOpacity key={story.name} style={{ marginRight: 25 }}>
          ...
          >
            <Image source={{ uri: story.image }} style={{ ...stylewh, borderRadius: 50 }} />
          </View>
